# Módulo Auditoría (`sgc_auditoria`)
...
| **Hallazgo Auditoria** | Un hallazgo detectado durante la Auditoría — puede escalar al mismo flujo CAPA que un Hallazgo de autoevaluación (ver [`capa.py`](../modulos/nucleo.md)). |
...
El rol **Auditor Interno** (ver [RBAC](../desarrollo/rbac.md)) crea y gestiona
