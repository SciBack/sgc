...
WF_PROGRAMA = {
    ...
    "is_active": 1,
    "send_email_alert": 0,  # dispara en CUALQUIER save con transicion pendiente (revertido 2026-07-19, rompio 70 tests); los avisos van por Notification Value Change, ver f15_notificaciones_workflow.py (#29).
    "states": [
