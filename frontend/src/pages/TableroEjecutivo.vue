    ...
    <div class="mx-auto max-w-7xl px-6 py-8 sm:px-8 xl:px-10">
      ...
      <template v-else>
        ...
        <section class="mb-6 grid gap-3 sm:grid-cols-3">
          <div class="sb-card bg-gradient-to-b from-marca-primaria-50 to-superficie p-5 sm:col-span-2">
            ...
            <div class="mt-1 flex items-baseline gap-2">
              ...
              <span class="text-p-sm text-tinta-suave">programas con autoevaluación iniciada</span>
            </div>
            ...
            <div class="mt-1.5 text-p-xs text-tinta-tenue">{{ cobertura.pct }}% del total de programas</div>
          </div>
          ...
          <div class="grid gap-3">
            <div class="sb-card p-4" :class="mejora.nc_abiertas ? 'border-peligro-tenue bg-peligro-tenue' : ''">
              ...
              <div class="text-p-xs text-tinta-suave">No conformidades abiertas</div>
            </div>
            <div class="sb-card p-4" :class="mejora.planes_riesgo ? 'border-peligro-tenue bg-peligro-tenue' : ''">
              ...
              <div class="text-p-xs text-tinta-suave">Planes de mejora en riesgo</div>
            </div>
          </div>
        </section>
        ...
        <section class="sb-card mb-6 p-5">
          ...
          <div v-if="!totalEstandares" class="text-p-sm text-tinta-tenue">
          ...
          <template v-else>
            ...
            <div class="mt-2 text-p-xs text-tinta-tenue">{{ totalEstandares }} estándares en total</div>
          </template>
        </section>
        ...
        <section class="sb-card mb-6 p-5">
          ...
          <div v-if="!riesgos.total" class="text-p-sm text-tinta-tenue">
          ...
          <template v-else>
            <div class="grid gap-3 sm:grid-cols-3">
              <div class="rounded-lg bg-superficie-2 p-3">
                ...
                <div class="text-p-xs text-tinta-suave">Abiertos (de {{ riesgos.total }})</div>
              </div>
              <div class="rounded-lg p-3" :class="riesgos.criticos ? 'bg-peligro-tenue' : 'bg-superficie-2'">
                ...
                <div class="text-p-xs text-tinta-suave">Nivel Alto o Extremo</div>
              </div>
              <div class="rounded-lg p-3" :class="riesgos.materializados ? 'bg-peligro-tenue' : 'bg-superficie-2'">
                ...
                <div class="text-p-xs text-tinta-suave">Materializados</div>
              </div>
            </div>
            <div class="mt-3 flex flex-wrap gap-2">
              <span
            ...
            <p v-if="riesgos.por_nivel?.sin_evaluar" class="mt-2 text-p-xs text-tinta-tenue">
        ...
        <section class="sb-card mb-6 p-5">
          ...
          <div v-if="!auditoria.total" class="text-p-sm text-tinta-tenue">
          ...
          <template v-else>
            <div class="grid gap-3 sm:grid-cols-3">
              <div class="rounded-lg bg-superficie-2 p-3">
                ...
                <div class="text-p-xs text-tinta-suave">Auditorías</div>
              </div>
              <div class="rounded-lg bg-superficie-2 p-3">
                <div class="font-display text-2xl font-bold text-tinta">{{ auditoria.hallazgos?.total || 0 }}</div>
                <div class="text-p-xs text-tinta-suave">Hallazgos</div>
              </div>
              <div class="rounded-lg p-3" :class="auditoria.hallazgos?.abiertos ? 'bg-aviso-tenue' : 'bg-superficie-2'">
                ...
                <div class="text-p-xs text-tinta-suave">Hallazgos abiertos</div>
              </div>
            </div>
            <div class="mt-3 flex flex-wrap gap-2">
              <span
        ...
        <section class="sb-card mb-6 p-5">
          ...
          <div v-if="!revision.ultima" class="text-p-sm text-tinta-tenue">
          ...
          <template v-else>
            <div class="flex flex-wrap items-baseline gap-2">
              ...
              <span class="text-p-xs text-tinta-tenue">{{ revision.ultima.fecha || 'sin fecha' }}</span>
            </div>
            <div class="mt-2 text-p-xs text-tinta-tenue">
          ...
          <div v-else class="space-y-2">
            ...
            >
              <div class="min-w-[160px] flex-1">
                ...
                <div class="text-p-xs text-tinta-tenue">{{ p.periodo_academico }} · {{ p.estado }}</div>
              </div>
