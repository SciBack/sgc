...
| Módulo | Estado | Detalle |
|---|---|---|
| **M07** Roles y comités | 🟡 Parcial | RBAC con 13 roles y comités operando; el acotamiento de visibilidad por programa está construido (opt-in) y listo para activarse asignando el programa a cada responsable. |
