...
| **Hallazgo Auditoria** | Un hallazgo detectado durante la Auditoría — puede escalar al mismo flujo CAPA que un Hallazgo de autoevaluación (ver [módulo Núcleo](/modulos/nucleo/)). |
