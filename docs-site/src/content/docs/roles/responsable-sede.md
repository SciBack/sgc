---
title: Responsable de Sede
description: Guía funcional para probar el rol Responsable de Sede.
---

## Propósito

Coordina y consulta información territorial de la sede.

## Acceso y precondiciones

Cuenta de sede y datos comparables de dos sedes. Inicia sesión únicamente con esta cuenta y confirma en el perfil que no acumule roles adicionales.

## Acciones permitidas

Lectura de los principales registros y catálogos según la matriz RBAC.

## Restricciones que deben probarse

El catálogo de código marca el alcance como parcial y menciona un ajuste pendiente; no asumir aislamiento sin User Permissions verificadas.
